function leaderboard() {
    ...
    var deportivoHuracan = {
        ...
        pe: 2,
        pp: 10,
        gf: 1+2+1+3+2+1+1+1+1,
        gc: 3+3+4+2+3+2+3+2+3+1,
        dif: -13,
        difStr: "-13"
    };
